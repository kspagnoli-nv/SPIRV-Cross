...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpEntryPoint Fragment %main "main" %texCoords_1 %cascadeIndex_1 %fragDepth_1 %lodLevel_1 %_entryPointOutput
               OpExecutionMode %main OriginUpperLeft
               OpSource HLSL 500
               OpName %main "main"
               OpName %_main_vf2_f1_f1_f1_ "@main(vf2;f1;f1;f1;"
               ...
               OpName %lodLevel_0 "lodLevel"
               OpName %lodLevel_1 "lodLevel"
               ...
               OpDecorate %lodLevel_1 Location 3
...
%_ptr_Function_float = OpTypePointer Function %float
    %v4float = OpTypeVector %float 4
         %11 = OpTypeFunction %v4float %_ptr_Function_v2float %_ptr_Function_float %_ptr_Function_float %_ptr_Function_float
...
%lodLevel_1 = OpVariable %_ptr_Input_float Input
...
%lodLevel_0 = OpVariable %_ptr_Function_float Function
    ...
    %param_2 = OpVariable %_ptr_Function_float Function
         ...
         %61 = OpLoad %float %lodLevel_1
               OpStore %lodLevel_0 %61
         ...
         %68 = OpLoad %float %fragDepth_0
               OpStore %param_1 %68
         %70 = OpLoad %float %lodLevel_0
               OpStore %param_2 %70
         %71 = OpFunctionCall %v4float %_main_vf2_f1_f1_f1_ %param %param_0 %param_1 %param_2
               OpStore %_entryPointOutput %71
               OpReturn
               OpFunctionEnd
%_main_vf2_f1_f1_f1_ = OpFunction %v4float None %11
...
%cascadeIndex = OpFunctionParameter %_ptr_Function_float
  %fragDepth = OpFunctionParameter %_ptr_Function_float
   %lodLevel = OpFunctionParameter %_ptr_Function_float
         %16 = OpLabel
         ...
         %42 = OpLoad %float %lodLevel
         %43 = OpImageSampleDrefExplicitLod %float %28 %39 %41 Lod %42
               OpStore %c %43
         %44 = OpLoad %float %c
         %45 = OpLoad %float %c
         %46 = OpLoad %float %c
